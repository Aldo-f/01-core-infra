...
| Plex | `templates/infra/01-core-plex/` | `~/dev/01-core-infra/plex/` |
| qBittorrent | `templates/infra/01-core-qbittorrent/` | `~/dev/01-core-infra/qbittorrent/` |
...
| 01-core-plex | pure-infra | ansible-copy |
| 01-core-qbittorrent | pure-infra | ansible-copy |
