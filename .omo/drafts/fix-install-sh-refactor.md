...
Cron template: hardcoded `/home/aldo/dev/01-core-infra/` + `aldo` + stray bell `\x07` chars (templates/cron/01-core-infra.cron:8,11) — no `__HOME__`/`__USER__`/`__CORE_INFRA__` used.
