...
# When invoked via `exec` from install.sh, BASH_SOURCE[0] resolves to scripts/deploy.sh,
# making REPO_DIR point at scripts/. Normalize it to the repo root.
if [ "$(basename "$REPO_DIR")" = "scripts" ]; then
